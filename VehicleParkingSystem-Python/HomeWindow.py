...
class HomeScreen(QMainWindow):
    def __init__(self):
        ...
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:#000000;color:#0000FF;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#000000;color:#0000FF;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#000000;color:#0000FF;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#000000;color:#0000FF;font-weight:bold;border:1px solid white")
    ...
    def addHomePageData(self):
        ...
        for data in alldata:
            ...
            if data[3]==1:
                label.setStyleSheet("background-color:blue;color:white;padding:5px;width:100px;height:100px;border:1px solid white;text-align:center;font-weight:bold")
            else:
                label.setStyleSheet("background-color:black;color:white;padding:5px;width:100px;height:100px;border:1px solid white;text-align:center;font-weight:bold")
